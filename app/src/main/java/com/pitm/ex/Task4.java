...
public class Task4 extends AppCompatActivity {
    ...
    public class Human {
        public Map<Integer, Task3.Person> map_people = new HashMap<>();

        public Task3.Person getPerson(int i) {
            return (Task3.Person) map_people.get(i);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.task1_notniystan);
    }

    public void click_next2(View v) {
        setContentView(R.layout.task4_registrtask);
    ...
    public void click_next(View v) {
        setContentView(R.layout.task4_registr2);
    }
    ...
    public void editFile(String result) {
        try {
            ...
            human.getPerson(readTxtFile()).progress.put(4, result);
